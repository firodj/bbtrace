...
void
write_u32(std::ostream &out, uint32_t u32)
{
    out.write((char*)&u32, sizeof(u32));
}

void
write_u64(std::ostream &out, uint64_t u64)
{
    out.write((char*)&u64, sizeof(u64));
}

void
write_bool(std::ostream &out, int b)
{
    out.put((char)b);
}
...
bool
read_match(std::istream &in, const char *signature)
{
